...
print(monthlycol)
Map.addLayer(monthlycol.first(),NDVIvis, 'lst monthly');
...
print(jan);
Map.addLayer(jan.first(),NDVIvis, 'jan 15 yr avg');
...
Map.addLayer(jun.first(),NDVIvis, 'jun 15 yr avg');
...
Export.table.toDrive({
  collection:janstat,
  folder: 'AF_Drought',
  description:"survey_HH_2019_modis_ndvi_15yr_poly_jan",
  fileFormat:"CSV",
  selectors: ['BAD','HH_ID','survey_typ','Month','urru','HH_dist_nm','HH_dist_cd','HH_prov_nm',
  'HH_prov_cd','urru','NDVI_mean_max', 'NDVI_mean_mean',
...
Export.table.toDrive({
  collection:febstat,
  folder: 'AF_Drought',
  description:"survey_HH_2019_modis_ndvi_15yr_poly_feb",
  fileFormat:"CSV",
  selectors: ['BAD','HH_ID','survey_typ','Month','urru','HH_dist_nm','HH_dist_cd','HH_prov_nm',
  'HH_prov_cd','urru','NDVI_mean_max', 'NDVI_mean_mean',
  'NDVI_mean_median','NDVI_mean_min','NDVI_mean_stdDev']
...
Export.table.toDrive({
  collection:marstat,
  folder: 'AF_Drought',
  description:"survey_HH_2019_modis_ndvi_15yr_poly_mar",
  fileFormat:"CSV",
  selectors: ['BAD','HH_ID','survey_typ','Month','urru','HH_dist_nm','HH_dist_cd','HH_prov_nm',
  'HH_prov_cd','urru','NDVI_mean_max', 'NDVI_mean_mean',
  'NDVI_mean_median','NDVI_mean_min','NDVI_mean_stdDev']
...
Export.table.toDrive({
  collection:aprstat,
  folder: 'AF_Drought',
  description:"survey_HH_2019_modis_ndvi_15yr_poly_apr",
  fileFormat:"CSV",
  selectors: ['BAD','HH_ID','survey_typ','Month','urru','HH_dist_nm','HH_dist_cd','HH_prov_nm',
  'HH_prov_cd','urru','NDVI_mean_max', 'NDVI_mean_mean',
  'NDVI_mean_median','NDVI_mean_min','NDVI_mean_stdDev']
...
Export.table.toDrive({
  collection:maystat,
  folder: 'AF_Drought',
  description:"survey_HH_2019_modis_ndvi_15yr_poly_may",
  fileFormat:"CSV",
  selectors: ['BAD','HH_ID','survey_typ','Month','urru','HH_dist_nm','HH_dist_cd','HH_prov_nm',
  'HH_prov_cd','urru','NDVI_mean_max', 'NDVI_mean_mean',
  'NDVI_mean_median','NDVI_mean_min','NDVI_mean_stdDev']
...
Export.table.toDrive({
  collection:junstat,
  folder: 'AF_Drought',
  description:"survey_HH_2019_modis_ndvi_15yr_poly_jun",
  fileFormat:"CSV",
  selectors: ['BAD','HH_ID','survey_typ','Month','urru','HH_dist_nm','HH_dist_cd','HH_prov_nm',
  'HH_prov_cd','urru','NDVI_mean_max', 'NDVI_mean_mean',
  'NDVI_mean_median','NDVI_mean_min','NDVI_mean_stdDev']
...
Export.table.toDrive({
  collection:julstat,
  folder: 'AF_Drought',
  description:"survey_HH_2019_modis_ndvi_15yr_poly_jul",
  fileFormat:"CSV",
  selectors: ['BAD','HH_ID','survey_typ','Month','urru','HH_dist_nm','HH_dist_cd','HH_prov_nm',
  'HH_prov_cd','urru','NDVI_mean_max', 'NDVI_mean_mean',
  'NDVI_mean_median','NDVI_mean_min','NDVI_mean_stdDev']
...
Export.table.toDrive({
  collection:augstat,
  folder: 'AF_Drought',
  description:"survey_HH_2019_modis_ndvi_15yr_poly_aug",
  fileFormat:"CSV",
  selectors: ['BAD','HH_ID','survey_typ','Month','urru','HH_dist_nm','HH_dist_cd','HH_prov_nm',
  'HH_prov_cd','urru','NDVI_mean_max', 'NDVI_mean_mean',
  'NDVI_mean_median','NDVI_mean_min','NDVI_mean_stdDev']
...
Export.table.toDrive({
  collection:sepstat,
  folder: 'AF_Drought',
  description:"survey_HH_2019_modis_ndvi_15yr_poly_sep",
  fileFormat:"CSV",
  selectors: ['BAD','HH_ID','survey_typ','Month','urru','HH_dist_nm','HH_dist_cd','HH_prov_nm',
  'HH_prov_cd','urru','NDVI_mean_max', 'NDVI_mean_mean',
  'NDVI_mean_median','NDVI_mean_min','NDVI_mean_stdDev']
...
Export.table.toDrive({
  collection:octstat,
  folder: 'AF_Drought',
  description:"survey_HH_2019_modis_ndvi_15yr_poly_oct",
  fileFormat:"CSV",
  selectors: ['BAD','HH_ID','survey_typ','Month','urru','HH_dist_nm','HH_dist_cd','HH_prov_nm',
  'HH_prov_cd','urru','NDVI_mean_max', 'NDVI_mean_mean',
  'NDVI_mean_median','NDVI_mean_min','NDVI_mean_stdDev']
...
Export.table.toDrive({
  collection:novstat,
  folder: 'AF_Drought',
  description:"survey_HH_2019_modis_ndvi_15yr_poly_nov",
  fileFormat:"CSV",
  selectors: ['BAD','HH_ID','survey_typ','Month','urru','HH_dist_nm','HH_dist_cd','HH_prov_nm',
  'HH_prov_cd','urru','NDVI_mean_max', 'NDVI_mean_mean',
  'NDVI_mean_median','NDVI_mean_min','NDVI_mean_stdDev']
...
Export.table.toDrive({
  collection:decstat,
  folder: 'AF_Drought',
  description:"survey_HH_2019_modis_ndvi_15yr_poly_dec",
  fileFormat:"CSV",
  selectors: ['BAD','HH_ID','survey_typ','Month','urru','HH_dist_nm','HH_dist_cd','HH_prov_nm',
  'HH_prov_cd','urru','NDVI_mean_max', 'NDVI_mean_mean',
  'NDVI_mean_median','NDVI_mean_min','NDVI_mean_stdDev']
